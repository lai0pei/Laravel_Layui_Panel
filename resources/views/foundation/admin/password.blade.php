        ...
        <div class="admin-form-box">
            ...
            <div class="admin-form-container">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" class="layui-input" name="repassword" placeholder="请再次输入账号密码" maxlength="20" lay-verify="required">
...
<script>
    layui.use(['jquery', 'form'], function() {
        ...
        form.on('submit(submit)', function(data) {
              ...
              let re = data.field.repassword;
              if(pass != re){
                fail('密码输入不相同');
                return false;
              }
              let res = post_request("{{$route['toAllPassword']}}", data.field, this);
        })
    })
