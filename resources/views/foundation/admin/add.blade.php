...
<div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="account" placeholder="请输入账号名称" maxlength="20" lay-verify="required">
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="username" placeholder="请输入账号昵称" maxlength="20" lay-verify="required">
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" class="layui-input" name="status" title="开启" value="1" checked>
            <input type="radio" class="layui-input" name="status" title="禁用" value="0" >
