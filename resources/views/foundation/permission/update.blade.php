...
@section('form')
<div>
    <input type="hidden" class="layui-input" name="id" value="{{$data['data']['id']}}" lay-verify="required">
    <div class="layui-form-item">
        <label class="layui-form-label admin-form-required">菜单名称</label>
        <div class="layui-input-block">
            <select name="menu_id" id="menu_id" lay-verify="required" lay-search lay-filter="menu_select">
    ...
    <div class="layui-form-item auth">
        ...
        <div class="layui-input-block">
            ...
            <p class="admin-form-tips" id="menu_sig_tips">请填写菜单识别符 ( 如：admin_add 为 管理员添加, admin_edit 为 管理员编辑, admin_delete 为 管理员删除)</p>
        </div>
    </div>
</div>
@endsection
